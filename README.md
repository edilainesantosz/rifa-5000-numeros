...
Este projeto foi desenvolvido a partir do projeto RifaGen, de Jeferson La, utilizado como referência para estudos e adaptações.

Projeto original:
https://github.com/jefersonla/rifa-typescript-app

Autor do projeto original:
Jeferson La (@jefersonla)
